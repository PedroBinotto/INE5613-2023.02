...
public class PessoaFisicaController {
    ...
    try {
      ...
      return ResponseEntity.ok(
          this.pessoaFisicaMapper.toDto(
              this.pessoaFisicaQuery.getPessoasFisicas(nomeFilter, sobrenomeFilter, cpfFilter)));
  ...
  public ResponseEntity<PessoaFisicaDetailCompositeDto> getPessoaFisicaById(
  ...
  public ResponseEntity<List<TelefoneResponseDto>> getTelefonesPessoaFisicaById(
      @PathVariable Long pessoaFisicaId) {
    return ResponseEntity.ok(
        this.telefoneMapper.toDto(this.telefoneQuery.getTelefonesByPessoaFisicaId(pessoaFisicaId)));
  }
  ...
  public ResponseEntity<Void> saveTelefonePessoaFisicaById(
      @PathVariable Long pessoaFisicaId, @RequestBody TelefoneSaveDto telefoneSaveDto) {
  ...
  public ResponseEntity<PessoaFisicaDetailCompositeDto> deleteTelefonePessoaFisicaById(
      @PathVariable Long pessoaFisicaId, @PathVariable Long telefoneId) {
  ...
  public ResponseEntity<Void> updatePessoaFisicaById(
      @PathVariable Long pessoaFisicaId, @RequestBody PessoaFisicaSaveDto pessoaFisica) {
