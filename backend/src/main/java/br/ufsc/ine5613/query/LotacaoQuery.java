...
public class LotacaoQuery {
  ...
  public List<LotacaoDetailCompositeDto> getLotacoes(
      List<Long> funcionarioFilter, List<Long> estabelecimentoFilter, List<String> cargoFilter) {
  ...
  public LotacaoDetailCompositeDto getLotacaoById(
      Long funcionarioId, Long estabelecimentoId, Long cargoId) {
  ...
  @Transactional
  public void deleteLotacaoById(Long funcionarioId, Long estabelecimentoId, Long cargoId) {
